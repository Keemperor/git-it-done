...
var resposSearchTerm = document.querySelector("#repo-search-term")
...
var getUserRepos = function (user) {
  ...
  .catch(function(error) {
    // this .catch() is being chained at the end of .then
    alert("Unable to contact GitHub");
  });
};
...
if (repos.length === 0) {
  ...
  resposSearchTerm.textContent = searchTerm;
